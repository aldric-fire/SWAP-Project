...
$canEdit = in_array($_SESSION['role'], ['Admin', 'Manager', 'Staff'], true);
?>
                ...
                <div class="products-grid">
                    <?php foreach ($items as $row): ?>
                        <div class="product-card">
                            ...
                            <p class="description">Quantity: <?php echo format_number($row['quantity']); ?></p>
                            <p class="description">Min Threshold: <?php echo format_number($row['min_threshold']); ?></p>
            ...
            <?php else: ?>
                <p>No inventory items found.
                    <?php if (in_array($_SESSION['role'], ['Admin', 'Manager', 'Staff'], true)): ?>
                        <br><a href="<?php echo BASE_URL; ?>/pages/add_product.php">Add your first item</a>
                    <?php endif; ?>
                </p>
            <?php endif; ?>
        </div>

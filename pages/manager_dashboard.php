...
<head>
    ...
    <title>Manager Dashboard - SIAMS</title>
...
<body class="has-sidebar">
    ...
    <div class="main-wrapper">
        ...
        <main>
            <div class="container">
                <div class="card">
                    <h3 class="mb-lg">Manager Dashboard</h3>
                    <p class="text-muted">Manage inventory, approve stock requests, and monitor operations.</p>

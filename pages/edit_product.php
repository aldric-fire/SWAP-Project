        ...
        <div class="card">
            ...
            <form method="POST" action="" onsubmit="return validateInventoryForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="quantity" name="quantity" min="0" value="<?php echo (int)$item['quantity']; ?>" required>
                </div>

                <div class="form-group">
                    <label for="min_threshold">Minimum Threshold:</label>
                    <input type="number" id="min_threshold" name="min_threshold" min="0" value="<?php echo (int)$item['min_threshold']; ?>" required>
                </div>

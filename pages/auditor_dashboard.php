...
<head>
    ...
    <title>Auditor Dashboard - SIAMS</title>
...
<body class="has-sidebar">
    ...
    <div class="main-wrapper">
        ...
        <main>
            <div class="container">
                <div class="card">
                    <h3 class="mb-lg">Auditor Dashboard</h3>
                    <p class="text-muted">Audit inventory records, view system logs, and generate compliance reports.</p>

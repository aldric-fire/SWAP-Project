        ...
        <div class="card">
            ...
            <form method="POST" action="" onsubmit="return validateInventoryForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="quantity" name="quantity" min="0" max="2147483647" placeholder="e.g., 15" value="<?php echo isset($quantity) ? (int)$quantity : ''; ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="min_threshold" name="min_threshold" min="0" max="2147483647" placeholder="e.g., 5" value="<?php echo isset($minThreshold) ? (int)$minThreshold : ''; ?>" required>
